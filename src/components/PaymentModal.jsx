...
const PaymentModal = ({ 
  ...
  const paymentMethods = [
    ...
    ...(COD_ENABLED ? [{ id: 'cod', name: 'Cash on Delivery', icon: Shield }] : []),
  ];
              ...
              <div className="p-6">
                ...
                {paymentMethod === 'card' && (
                 <form onSubmit={handleSubmit} className="space-y-8">
                   ...
                   <div className="space-y-6">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                       <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                         ...
                         {errors.cardNumber && (
                           <motion.p initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="text-red-500 text-sm mt-2 flex items-center">
                       ...
                       <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                         <label className="block text-sm font-semibold text-gray-700 mb-3">Card Holder Name</label>
                         <input
                           type="text"
                   ...
                   <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 border border-gray-100">
                   ...
                   {/* GSTIN */}
                   <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55 }} className="rounded-2xl">
               ...
               {/* Placeholder for others (paypal/crypto) */}
              </div>
            )}
          </motion.div>
        </motion.div>
